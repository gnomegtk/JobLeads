...
// Returns the private 'App\Repository\CountyRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CountyRepository.php';

return $this->privates['App\\Repository\\CountyRepository'] = new \App\Repository\CountyRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
