...
{% macro render_table(logs, category = '', show_level = false, is_deprecation = false) %}
    ...
    <table class=\"logs\"{% if show_level %} data-filter-level=\"Emergency,Alert,Critical,Error,Warning,Notice,Info\"{% endif %}{% if filter %} data-filters{% endif %}>
        <thead class=\"thead-dark\">
            <tr>
                {% if show_level %}<th data-filter=\"level\">Level</th>{% else %}<th scope=\"col\">Time</th>{% endif %}
...
{% macro render_log_message(category, log_index, log) %}
    ...
    {% endif %}
{% endmacro %}
", "@WebProfiler/Collector/logger.html.twig", "/data/jobleads/project/vendor/symfony/web-profiler-bundle/Resources/views/Collector/logger.html.twig");
    }
}
