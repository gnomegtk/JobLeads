...
";
    ...
    ";
        ...
        <thead class=\"small\">
            <tr>
                <th scope=\"col\">Symfony Status</th>
                <th scope=\"col\">Bugs ";
        // line 140
...
{% block panel %}
    ...
    <table>
        <thead class=\"small\">
            <tr>
                <th scope=\"col\">Symfony Status</th>
                <th scope=\"col\">Bugs {{ collector.symfonystate in ['eom', 'eol'] ? 'were' : 'are' }} fixed until</th>
                <th scope=\"col\">Security issues {{ collector.symfonystate == 'eol' ? 'were' : 'are' }} fixed until</th>
                <th scope=\"col\"></th>
            </tr>
        </thead>
        <tbody>
    ...
    {% endif %}
{% endblock %}
", "@WebProfiler/Collector/config.html.twig", "/data/jobleads/project/vendor/symfony/web-profiler-bundle/Resources/views/Collector/config.html.twig");
    }
}
